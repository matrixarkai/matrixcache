...
impl CacheOptions {
    ...
    pub fn with_replacement_policy(mut self, policy: CacheReplacementPolicy) -> Self {
        let name = policy.as_cxx_name().to_string();
    ...
    pub fn with_dram_pmem_data_placement(
        ...
        self.cache_dram_pmem_data_placement_type = placement.as_cxx_name().to_string();
        self.cache_dram_pmem_data_placement_threshold = threshold;
        self
    }

    pub fn with_cxx_dram_pmem_data_placement(
        self,
    ...
    pub fn WithDRAMPMEMDataPlacement(
        ...
        self.with_cxx_dram_pmem_data_placement(placement, threshold)
    }
    ...
    pub fn tiering_policy(&self) -> CacheTieringPolicy {
        ...
        CacheTieringPolicy {
            ...
            data_placement: CacheDataPlacement::from_cxx_name(
