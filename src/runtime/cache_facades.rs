...
impl FlexibleCache {
    pub fn new(
        ...
        let policy = ReplacementPolicyType::from_cxx_name(policy.as_ref());
        let engine = StorageEngineType::from_cxx_name(engine.as_ref());
...
impl MultiTierCache {
    ...
    pub fn try_new(
        ...
        let policy_type = ReplacementPolicyType::from_cxx_name(policy.as_ref());
        let replacement_policy = policy_type.as_cache_policy();
        let ssd_storage_engine = StorageEngineType::from_cxx_name(ssd_storage_engine.as_ref());
        let data_placement =
            CacheDataPlacement::try_from_cxx_name(dram_pmem_data_placement_type.as_ref())?;
    ...
    pub fn cache_stats_summary_line(
        ...
        format!(
            ...
            metrics.as_ref(),
            comments.as_ref(),
            self.policy.as_cxx_name(),
            self.ssd_storage_engine.as_cxx_name(),
            self.cache.production_tiering_policy().data_placement.as_cxx_name(),
