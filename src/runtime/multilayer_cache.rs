...
impl MultiLayerCache {
    ...
    fn build_with_options(options: CacheOptions) -> Self {
        ...
        cache.set_replacement_policy_for_tier(
            CacheTier::Memory,
            CacheReplacementPolicy::from_cxx_name(&options.cache_dram_replacement_policy),
        );
        cache.set_replacement_policy_for_tier(
            CacheTier::Pmem,
            CacheReplacementPolicy::from_cxx_name(&options.cache_pmem_replacement_policy),
        );
        cache.set_replacement_policy_for_tier(
            CacheTier::Ssd,
            CacheReplacementPolicy::from_cxx_name(&options.cache_ssd_replacement_policy),
        );
    ...
    pub fn SetDRAMPMEMDataPlacementType(&self, placement: DRAMPMEMDataPlacementType) {
        self.set_cxx_data_placement_type(placement);
    }
    ...
    pub fn cxx_data_placement_type(&self) -> DRAMPMEMDataPlacementType {
    ...
    pub fn set_cxx_data_placement_type(&self, placement: DRAMPMEMDataPlacementType) {
