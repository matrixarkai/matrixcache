...
impl SSDEngineType {
    ...
    #[allow(non_snake_case)]
    pub fn FromCxxName(value: &str) -> Self {
        Self::from_cxx_name(value)
    }

    #[allow(non_snake_case)]
    pub fn AsCxxName(self) -> &'static str {
        self.as_cxx_name()
    }
}
...
impl StorageEngineType {
    ...
    pub fn from_cxx_code(value: u8) -> Self {
        match value {
            1 => Self::kPMEM,
            2 => Self::kSSD,
            3 => Self::kSimple,
    ...
    pub fn as_cxx_enum_name(self) -> &'static str {
        match self {
    ...
    #[allow(non_snake_case)]
    pub fn FromCxxCode(value: u8) -> Self {
        Self::from_cxx_code(value)
    }

    #[allow(non_snake_case)]
    pub fn CxxCode(self) -> u8 {
        self.cxx_code()
    }
    ...
    #[allow(non_snake_case)]
    pub fn AsCxxEnumName(self) -> &'static str {
        self.as_cxx_enum_name()
    }
...
impl CacheDataPlacement {
    pub fn try_from_cxx_name(value: &str) -> Result<Self, CacheError> {
...
impl DRAMPMEMDataPlacementType {
    pub fn try_from_cxx_name(value: &str) -> Result<Self, CacheError> {
        Ok(match CacheDataPlacement::try_from_cxx_name(value)? {
...
impl CacheAccessRecordType {
    ...
    pub fn from_cxx_code(code: u8) -> Option<Self> {
        match code {
            1 => Some(Self::Put),
            2 => Some(Self::Get),
            3 => Some(Self::Delete),
    ...
    #[allow(non_snake_case)]
    pub fn FromCxxCode(code: u8) -> Option<Self> {
        Self::from_cxx_code(code)
    }
