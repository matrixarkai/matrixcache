...
pub fn prometheus_text_into_with_label_scratch(
    ...
    metric_f64(&mut out, "matrixcache_read_through_latency_max_seconds", "read through peak latency", "gauge", tags, stats.read_through_latency_max_micros as f64 / 1_000_000.0);
    ...
    metric_f64(&mut out, "matrixcache_refill_latency_max_seconds", "refill peak latency", "gauge", tags, stats.refill_latency_max_micros as f64 / 1_000_000.0);
    metric_f64(&mut out, "matrixcache_refill_latency_p50_seconds", "refill p50 latency", "gauge", tags, percentile_seconds(stats.refill_latency_samples, stats.refill_latency_le_10us, stats.refill_latency_le_100us, stats.refill_latency_le_1ms, stats.refill_latency_le_10ms, stats.refill_latency_gt_10ms, stats.refill_latency_max_micros, 50));
    metric_f64(&mut out, "matrixcache_refill_latency_p95_seconds", "refill p95 latency", "gauge", tags, percentile_seconds(stats.refill_latency_samples, stats.refill_latency_le_10us, stats.refill_latency_le_100us, stats.refill_latency_le_1ms, stats.refill_latency_le_10ms, stats.refill_latency_gt_10ms, stats.refill_latency_max_micros, 95));
    metric_f64(&mut out, "matrixcache_refill_latency_p99_seconds", "refill p99 latency", "gauge", tags, percentile_seconds(stats.refill_latency_samples, stats.refill_latency_le_10us, stats.refill_latency_le_100us, stats.refill_latency_le_1ms, stats.refill_latency_le_10ms, stats.refill_latency_gt_10ms, stats.refill_latency_max_micros, 99));
    ...
    metric_f64(&mut out, "matrixcache_writeback_latency_max_seconds", "writeback peak latency", "gauge", tags, stats.writeback_latency_max_micros as f64 / 1_000_000.0);
    ...
    metric_f64(&mut out, "matrixcache_writeback_latency_p99_seconds", "writeback p99 latency", "gauge", tags, percentile_seconds(stats.writeback_latency_samples, stats.writeback_latency_le_10us, stats.writeback_latency_le_100us, stats.writeback_latency_le_1ms, stats.writeback_latency_le_10ms, stats.writeback_latency_gt_10ms, stats.writeback_latency_max_micros, 99));
    ...
    metric_f64(&mut out, "matrixcache_eviction_latency_max_seconds", "eviction peak latency", "gauge", tags, stats.eviction_latency_max_micros as f64 / 1_000_000.0);
    ...
    metric_f64(&mut out, "matrixcache_compaction_latency_max_seconds", "compaction peak latency", "gauge", tags, stats.compaction_latency_max_micros as f64 / 1_000_000.0);
    ...
    metric_f64(&mut out, "matrixcache_compaction_latency_p99_seconds", "compaction p99 latency", "gauge", tags, percentile_seconds(stats.compaction_latency_samples, stats.compaction_latency_le_10us, stats.compaction_latency_le_100us, stats.compaction_latency_le_1ms, stats.compaction_latency_le_10ms, stats.compaction_latency_gt_10ms, stats.compaction_latency_max_micros, 99));
