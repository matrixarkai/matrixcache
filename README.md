...
- `tools/compare_scale_reports.py` -- compares two scale report manifests and
  ...
  comparison. Add `--emit-operator-log` to print a compact logfmt line for build logs and Grafana annotations. Validate archived comparison JSON with `tools/validate_scale_comparison_report.py`.
